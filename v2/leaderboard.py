...
def calculate_leaderboards(league: League, doh_accolades, doh_weeks) -> Dict:
    """
    ...
    sorted_doh_weeks = sorted(doh_weeks, key=lambda item: (item["manager"], item["week"]))
